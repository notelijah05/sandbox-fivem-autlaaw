...
AddEventHandler("Businesses:Server:Startup", function()
	exports["sandbox-base"]:RegisterServerCallback("Businesses:VANGELICOGRAPESEED:OpenTable", function(source, data, cb)
		exports['sandbox-inventory']:OpenSecondary(source, 221, data)
	end)

	exports["sandbox-base"]:RegisterServerCallback("Businesses:VANGELICOGRAPESEED:Sell", function(source, data, cb)
		...
		if exports['sandbox-jobs']:HasJob(source, _jobName, false, false, false, false, "JOB_SELL_GEMS") then
			...
			if its and #its > 0 then
				...
				exports['sandbox-hud']:NotifError(source, "You Don't Have Any Gems To Sell")
			end
		end
	end)
end)

...
export default () => {
		...
		if (menuData.showing) {
			...
			dispatch({
				...
				payload: {
					...
					patrol: currentMenuData.labeledIndex?.[currentMenuValue]
						? currentMenuData.labeledIndex[currentMenuValue]
						: currentMenuValue,
				},
			});
		}
	...
	return (
		<Fade in={showingRadar} duration={2500}>
			<div className={classes.wrapper}>
				<Grid container spacing={1}>
					<Grid item xs={12}>
						<p className={`${classes.label} ${classes.brand}`}>
							PROWLER
						</p>
					...
					<Grid item xs={4}>
						<Button
							size="small"
							disabled={!radarSettings.frontRadar.transmit}
							fullWidth
							variant="contained"
							color={
								!radarSettings.frontRadar.lane
									? 'primary'
									: 'secondary'
							}
							onClick={() => {
								Nui.send('UpdateSettings', {
									...
									frontRadar: {
										lane: false,
										transmit:
											radarSettings.frontRadar.transmit,
									},
								});
							}}
						>
					...
					<Grid item xs={4}>
						<Button
							size="small"
							disabled={!radarSettings.rearRadar.transmit}
							fullWidth
							variant="contained"
							color={
								!radarSettings.rearRadar.lane
									? 'primary'
									: 'secondary'
							}
							onClick={() => {
								Nui.send('UpdateSettings', {
									...
									rearRadar: {
										lane: false,
										transmit:
											radarSettings.rearRadar.transmit,
									},
								});
							}}
						>
					...
					<Grid item xs={4}>
						<Button
							...
							variant="contained"
							color="secondary"
							disabled={!menuData.showing}
							onClick={IncrementMenuValue}
						>

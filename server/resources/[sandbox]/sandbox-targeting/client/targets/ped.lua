...
exports("AddPed", function(entityId, icon, menuArray, proximity)
...
exports("RemovePed", function(entityId)
    interactablePeds[entityId] = nil
end)

exports("AddPedModel", function(modelId, icon, menuArray, proximity)
...
exports("RemovePedModel", function(modelId)

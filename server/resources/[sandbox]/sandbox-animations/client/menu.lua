...
AddEventHandler('Animations:Client:EmoteMenuEmote', function(data)
    exports['sandbox-animations']:EmotesPlay(data, true)
    Wait(250)
    exports['sandbox-animations']:OpenMainEmoteMenu()
end)

AddEventHandler('Animations:Client:EmoteMenuWalkStyle', function(data)
    exports['sandbox-animations']:PedFeaturesSetWalk(data.walk, data.label)
end)

AddEventHandler('Animations:Client:EmoteMenuExpressions', function(data)
    exports['sandbox-animations']:PedFeaturesSetExpression(data.exp, data.label)
end)

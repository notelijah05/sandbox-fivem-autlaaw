...
RegisterNUICallback("GetTeams", function(data, cb)
	exports["sandbox-base"]:ServerCallback("Laptop:Teams:Get", {}, cb)
end)

RegisterNUICallback("GetTeamRequests", function(data, cb)
	exports["sandbox-base"]:ServerCallback("Laptop:Teams:GetRequests", {}, cb)
end)

RegisterNUICallback("CreateTeam", function(data, cb)
	exports["sandbox-base"]:ServerCallback("Laptop:Teams:Create", data, cb)
end)

RegisterNUICallback("InviteTeamMember", function(data, cb)
	exports["sandbox-base"]:ServerCallback("Laptop:Teams:Members:Invite", data, cb)
end)

RegisterNUICallback("RemoveTeamMember", function(data, cb)
	exports["sandbox-base"]:ServerCallback("Laptop:Teams:Members:Remove", data, cb)
end)

RegisterNUICallback("RequestTeamInvite", function(data, cb)
	exports["sandbox-base"]:ServerCallback("Laptop:Teams:RequestInvite", data, cb)
end)

RegisterNUICallback("DeleteTeam", function(data, cb)
	exports["sandbox-base"]:ServerCallback("Laptop:Teams:Delete", data, cb)
end)

RegisterNUICallback("TeamRequest", function(data, cb)
	exports["sandbox-base"]:ServerCallback("Laptop:Teams:ActionRequest", data, function()
		cb('OK')
	end)
end)
...
AddEventHandler("Laptop:Client:Teams:RequestNotifAccept", function(data)
	...
	exports["sandbox-base"]:ServerCallback("Laptop:Teams:ActionRequest", {
		id = data.request,
		action = "accept",
	})
end)

...
RegisterNetEvent("Objects:Server:Create", function(data, endCoords)
	local src = source
	exports['sandbox-objects']:Create(src, data.type, data.isTemp, data.model, endCoords.coords, endCoords.rotation,
		data.isFrozen,
		data.nameOverride)
end)
...
RegisterNetEvent("Objects:Server:Delete", function(id)
	local src = source
	exports['sandbox-objects']:Delete(src, id)
end)

RegisterNetEvent("Objects:Server:View", function(id)
	local src = source
	exports['sandbox-objects']:Info(src, id)
end)
